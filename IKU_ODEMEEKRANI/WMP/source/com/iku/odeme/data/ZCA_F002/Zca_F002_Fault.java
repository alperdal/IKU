...
public class Zca_F002_Fault extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    protected  Zca_F002_Fault (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    public  Zca_F002_Fault () {
    ...
    public void setName(com.iku.odeme.data.ZCA_F002.Zca_F002_Fault.NameType Name) {
    ...
    public MetaData metadataZca_F002_Fault() {
        return metadata;
    }

    public com.iku.odeme.data.ZCA_F002.Zca_F002_Fault.NameType getName() {
        return (com.iku.odeme.data.ZCA_F002.Zca_F002_Fault.NameType)baseTypeData().getElementValue(0);
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Zca_F002_Fault parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Zca_F002_Fault parent) {
            this.parent = parent;
