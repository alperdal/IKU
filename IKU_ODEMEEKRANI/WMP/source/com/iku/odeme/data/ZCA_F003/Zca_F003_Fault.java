...
public class Zca_F003_Fault extends com.sap.aii.proxy.framework.core.AbstractType{

    private  static final com.sap.aii.proxy.framework.core.BaseTypeDescriptor staticDescriptor ;

    private  static final com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo = new com.sap.aii.proxy.framework.core.GenerationInfo("2.0", 1394712396392L) ;

    private  Zca_F003_Fault.MetaData metadata = new MetaData(this) ;

    static {
        com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor = createNewBaseTypeDescriptor(com.sap.aii.proxy.framework.core.XsdlConstants.XSDL_COMPLEX_TYPE, "urn:sap-com:document:sap:rfc:functions", "ZCA_F003.Exception", 4, 0, com.iku.odeme.data.ZCA_F003.Zca_F003_Fault.class, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_XML, "ZCA_F003", 0, 0, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:container xmlns:ifr=\"urn:sap-com:ifr:v2:metamodel\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"><ifr:descriptor><ifr:description language=\"TR\">Ücret verilerinin kayıt edilmesi</ifr:description></ifr:descriptor><ifr:properties><ifr:sourceSystem /><ifr:sourceClient>100</ifr:sourceClient><ifr:release>702 </ifr:release><ifr:package>ZFI</ifr:package><ifr:akhNode /><ifr:released>no</ifr:released><ifr:outbound>false</ifr:outbound><ifr:synchronous>true</ifr:synchronous><ifr:asynchronous>false</ifr:asynchronous><ifr:unicode1>true</ifr:unicode1><ifr:unicode2>true</ifr:unicode2></ifr:properties><ifr:definition /></ifr:container>");
        descriptorSetElementProperties(descriptor, 0, "Name", null, null, "unqualified", "http://www.w3.org/2001/XMLSchema:string", "urn:sap-com:document:sap:rfc:functions", false, 1, 1, false, null, "Name", com.iku.odeme.data.ZCA_F003.Zca_F003_Fault.NameType.class, null, new java.lang.String[][]{{"enumeration", "E_DATE"}, {"enumeration", "E_PERSL"}, {"enumeration", "E_TRIG"}, {"enumeration", "E_UNAME"}}, null, 0, 0, 0, -1, -1, -1, -1, 0, null);
    ...
    public  Zca_F003_Fault () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_XML);
        
    }

    protected  Zca_F003_Fault (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
    ...
    public MetaData metadataZca_F003_Fault() {
        return metadata;
    }
    ...
    public void setName(com.iku.odeme.data.ZCA_F003.Zca_F003_Fault.NameType Name) {
    ...
    public com.iku.odeme.data.ZCA_F003.Zca_F003_Fault.NameType getName() {
        return (com.iku.odeme.data.ZCA_F003.Zca_F003_Fault.NameType)baseTypeData().getElementValue(0);
    }
    ...
    public static class MessageType extends com.sap.aii.proxy.framework.core.AbstractType{
        ...
        private  static final com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo = new com.sap.aii.proxy.framework.core.GenerationInfo("2.0", 1394712396393L) ;
    ...
    public static class NameType extends com.sap.aii.proxy.framework.core.EnumerationType implements java.io.Serializable {
        ...
        public  static final java.lang.String _E_TRIG = "E_TRIG" ;
    
        /** instance for value E_TRIG */
        public  static final NameType E_TRIG = new NameType(_E_TRIG) ;
    
        public  static final java.lang.String _E_DATE = "E_DATE" ;
    
        /** instance for value E_DATE */
        public  static final NameType E_DATE = new NameType(_E_DATE) ;
        ...
        public static NameType fromString(java.lang.String name) {
            if (name.equals("E_TRIG")){return E_TRIG;};
            if (name.equals("E_DATE")){return E_DATE;};
        ...
        public static NameType fromValue(java.lang.String name) {
            if (name.equals(_E_TRIG)){return E_TRIG;};
            if (name.equals(_E_DATE)){return E_DATE;};
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Zca_F003_Fault parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Zca_F003_Fault parent) {
            this.parent = parent;
