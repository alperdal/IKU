...
public class Zca_F004_Output extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    protected  Zca_F004_Output (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    public  Zca_F004_Output () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO);
        
    }

    public void setT_Data(com.iku.odeme.data.ZCA_F004.Zca_S_F004Type[] T_Data) {
        baseTypeData().setElementValue(0, new com.iku.odeme.data.ZCA_F004.util.Zca_S_F004Type_List());
    ...
    public com.iku.odeme.data.ZCA_F004.Zca_S_F004Type[] getT_Data() {
        com.iku.odeme.data.ZCA_F004.util.Zca_S_F004Type_List i$ = (com.iku.odeme.data.ZCA_F004.util.Zca_S_F004Type_List)baseTypeData().getElementValue(0);
    ...
    public MetaData metadataZca_F004_Output() {
        return metadata;
    }

    public com.iku.odeme.data.ZCA_F004.util.Zca_S_F004Type_List get_as_listT_Data() {
        return (com.iku.odeme.data.ZCA_F004.util.Zca_S_F004Type_List)baseTypeData().getElementValue(0);
    }

    public static class MetaData implements java.io.Serializable {
    
        private  Zca_F004_Output parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Zca_F004_Output parent) {
            this.parent = parent;
