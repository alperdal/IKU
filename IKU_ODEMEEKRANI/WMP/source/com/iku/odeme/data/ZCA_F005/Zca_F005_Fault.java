...
public class Zca_F005_Fault extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    protected  Zca_F005_Fault (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    public  Zca_F005_Fault () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_XML);
        
    }

    public MetaData metadataZca_F005_Fault() {
        return metadata;
    }

    public void setName(com.iku.odeme.data.ZCA_F005.Zca_F005_Fault.NameType Name) {
    ...
    public com.iku.odeme.data.ZCA_F005.Zca_F005_Fault.NameType getName() {
        return (com.iku.odeme.data.ZCA_F005.Zca_F005_Fault.NameType)baseTypeData().getElementValue(0);
    }
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Zca_F005_Fault parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Zca_F005_Fault parent) {
            this.parent = parent;
