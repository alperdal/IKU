...
public class Zca_F005_Input extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    private  Zca_F005_Input.MetaData metadata = new MetaData(this) ;

    static {
        com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor = createNewBaseTypeDescriptor(com.sap.aii.proxy.framework.core.XsdlConstants.WSDL_MESSAGE_FOR_JCO, "urn:sap-com:document:sap:rfc:functions", "ZCA_F005.Input", 3, 0, com.iku.odeme.data.ZCA_F005.Zca_F005_Input.class, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_JCO, "ZCA_F005", 0, 0, 0, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<ifr:container xmlns:ifr=\"urn:sap-com:ifr:v2:metamodel\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"><ifr:descriptor><ifr:description language=\"TR\">İndirim türlerinin güncellenmesi</ifr:description></ifr:descriptor><ifr:properties><ifr:sourceSystem /><ifr:sourceClient>100</ifr:sourceClient><ifr:release>702 </ifr:release><ifr:package>ZFI</ifr:package><ifr:akhNode /><ifr:released>no</ifr:released><ifr:outbound>false</ifr:outbound><ifr:synchronous>true</ifr:synchronous><ifr:asynchronous>false</ifr:asynchronous><ifr:unicode1>true</ifr:unicode1><ifr:unicode2>true</ifr:unicode2></ifr:properties><ifr:definition /></ifr:container>");
    ...
    public com.iku.odeme.data.ZCA_F005.Zca_S_F005Type[] getT_Data() {
        com.iku.odeme.data.ZCA_F005.util.Zca_S_F005Type_List i$ = (com.iku.odeme.data.ZCA_F005.util.Zca_S_F005Type_List)baseTypeData().getElementValue(2);
        if ( i$ == null){return null;}
        return  i$.toArrayZca_S_F005Type();
    }
    ...
    public void setT_Data(com.iku.odeme.data.ZCA_F005.Zca_S_F005Type[] T_Data) {
        baseTypeData().setElementValue(2, new com.iku.odeme.data.ZCA_F005.util.Zca_S_F005Type_List());
        com.iku.odeme.data.ZCA_F005.util.Zca_S_F005Type_List list$ = get_as_listT_Data();
        for (int  i$ = 0; i$ < T_Data.length; i$++){
         list$.addZca_S_F005Type(T_Data[ i$]);
        }
    }

    public com.iku.odeme.data.ZCA_F005.util.Zca_S_F005Type_List get_as_listT_Data() {
        return (com.iku.odeme.data.ZCA_F005.util.Zca_S_F005Type_List)baseTypeData().getElementValue(2);
    }

    public void setI_Uname(java.lang.String I_Uname) {
        baseTypeData().setElementValue(1, I_Uname);
    }

    public static class MetaData implements java.io.Serializable {
    
        private  Zca_F005_Input parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Zca_F005_Input parent) {
            this.parent = parent;
