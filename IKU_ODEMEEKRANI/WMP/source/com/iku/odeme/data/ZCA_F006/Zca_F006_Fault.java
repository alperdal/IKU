...
public class Zca_F006_Fault extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public  Zca_F006_Fault () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_XML);
        
    }

    protected  Zca_F006_Fault (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    public void setName(com.iku.odeme.data.ZCA_F006.Zca_F006_Fault.NameType Name) {
        baseTypeData().setElementValue(0, Name);
    }

    public MetaData metadataZca_F006_Fault() {
        return metadata;
    }
    ...
    public com.iku.odeme.data.ZCA_F006.Zca_F006_Fault.NameType getName() {
        return (com.iku.odeme.data.ZCA_F006.Zca_F006_Fault.NameType)baseTypeData().getElementValue(0);
    }
    ...
    public static class AttributesType extends com.sap.aii.proxy.framework.core.AbstractType{
        ...
        private  static final com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo = new com.sap.aii.proxy.framework.core.GenerationInfo("2.0", 1394791190156L) ;
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Zca_F006_Fault parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Zca_F006_Fault parent) {
            this.parent = parent;
