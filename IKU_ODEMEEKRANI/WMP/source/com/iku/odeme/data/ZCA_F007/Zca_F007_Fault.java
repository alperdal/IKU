...
public class Zca_F007_Fault extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public  Zca_F007_Fault () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_XML);
        
    }

    protected  Zca_F007_Fault (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    public void setName(com.iku.odeme.data.ZCA_F007.Zca_F007_Fault.NameType Name) {
    ...
    public MetaData metadataZca_F007_Fault() {
        return metadata;
    }
    ...
    public com.iku.odeme.data.ZCA_F007.Zca_F007_Fault.NameType getName() {
        return (com.iku.odeme.data.ZCA_F007.Zca_F007_Fault.NameType)baseTypeData().getElementValue(0);
    }
    ...
    public static class MessageType extends com.sap.aii.proxy.framework.core.AbstractType{
        ...
        private  static final com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo = new com.sap.aii.proxy.framework.core.GenerationInfo("2.0", 1394712487695L) ;
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Zca_F007_Fault parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Zca_F007_Fault parent) {
            this.parent = parent;
