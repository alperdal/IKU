...
public class Zca_F007_Input extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    protected  Zca_F007_Input (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    public  Zca_F007_Input () {
    ...
    public MetaData metadataZca_F007_Input() {
        return metadata;
    }
    ...
    public com.iku.odeme.data.ZCA_F007.Zca_S_F007Type[] getT_Data() {
        com.iku.odeme.data.ZCA_F007.util.Zca_S_F007Type_List i$ = (com.iku.odeme.data.ZCA_F007.util.Zca_S_F007Type_List)baseTypeData().getElementValue(4);
    ...
    public com.iku.odeme.data.ZCA_F007.util.Zca_S_F007Type_List get_as_listT_Data() {
        return (com.iku.odeme.data.ZCA_F007.util.Zca_S_F007Type_List)baseTypeData().getElementValue(4);
    }

    public void setT_Data(com.iku.odeme.data.ZCA_F007.Zca_S_F007Type[] T_Data) {
        baseTypeData().setElementValue(4, new com.iku.odeme.data.ZCA_F007.util.Zca_S_F007Type_List());
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Zca_F007_Input parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Zca_F007_Input parent) {
            this.parent = parent;
