...
public class Zca_F008_Fault extends com.sap.aii.proxy.framework.core.AbstractType{
    ...
    public  Zca_F008_Fault () {
        super(staticDescriptor, staticGenerationInfo, com.sap.aii.proxy.framework.core.FactoryConstants.CONNECTION_TYPE_XML);
        
    }

    protected  Zca_F008_Fault (com.sap.aii.proxy.framework.core.BaseTypeDescriptor descriptor, com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo, int connectionType) {
        super(descriptor, staticGenerationInfo, connectionType);
    }

    public MetaData metadataZca_F008_Fault() {
        return metadata;
    }
    ...
    public void setName(com.iku.odeme.data.ZCA_F008.Zca_F008_Fault.NameType Name) {
    ...
    public com.iku.odeme.data.ZCA_F008.Zca_F008_Fault.NameType getName() {
        return (com.iku.odeme.data.ZCA_F008.Zca_F008_Fault.NameType)baseTypeData().getElementValue(0);
    }
    ...
    public static class MessageType extends com.sap.aii.proxy.framework.core.AbstractType{
        ...
        private  static final com.sap.aii.proxy.framework.core.GenerationInfo staticGenerationInfo = new com.sap.aii.proxy.framework.core.GenerationInfo("2.0", 1394712539496L) ;
    ...
    public static class NameType extends com.sap.aii.proxy.framework.core.EnumerationType implements java.io.Serializable {
        ...
        public  static final java.lang.String _E_TAKSITSAYISI = "E_TAKSITSAYISI" ;
    
        /** instance for value E_TAKSITSAYISI */
        public  static final NameType E_TAKSITSAYISI = new NameType(_E_TAKSITSAYISI) ;
        ...
        public static NameType fromString(java.lang.String name) {
            if (name.equals("E_TAKSITSAYISI")){return E_TAKSITSAYISI;};
        ...
        public static NameType fromValue(java.lang.String name) {
            if (name.equals(_E_TAKSITSAYISI)){return E_TAKSITSAYISI;};
    ...
    public static class MetaData implements java.io.Serializable {
        ...
        private  Zca_F008_Fault parent ;
    
        private  static final long serialVersionUID = -386313361L ;
    
        protected  MetaData (Zca_F008_Fault parent) {
            this.parent = parent;
